const translation = {
  en: {
    ...
    subtitle: {
      ...
      faction: 'Faction',
      progress: 'Progress',
      planetarium: 'Planets of your empire',
      market: 'Market of the galaxy',
      store: 'Game store',
      galaxy: 'Galactic map',
      relicarium: 'Relics available',
      temple: 'Religion factions',
      research: 'Skill trees',
      hangar: 'Ship construction',
      infrastructure: 'Building construction',
      defense: 'Tower construction',
      senate: 'Referendum votes',
      census: 'Player ranking',
      transmission: 'Messages received',
      bonus: 'Bonus',
      quantity: 'Available quantity',
      resource: 'Main resource',
      skills: 'Available skill points',
  ...
  es: {
    ...
    subtitle: {
      ...
      faction: 'Facción',
      progress: 'Progreso',
      planetarium: 'Planetas de tu imperio',
      market: 'Mercado de la galaxia',
      store: 'Tienda del juego',
      galaxy: 'Mapa galáctico',
      relicarium: 'Reliquias disponibles',
      temple: 'Facciones religiosas',
      research: 'Árbol de habilidades',
      hangar: 'Construcción de naves',
      infrastructure: 'Construcción de edificios',
      defense: 'Construcción de torres',
      senate: 'Votaciones de referendums',
      census: 'Ranking de jugadores',
      transmission: 'Mensajes recibidos',
      bonus: 'Bonus',
